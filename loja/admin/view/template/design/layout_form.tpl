            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                   ...
                   <?php if ($layout_module['position'] == 'top_slideshow') { ?>
                    <option value="top_slideshow" selected="selected">Top Slideshow</option>
                    <?php } else { ?>
                    <option value="top_slideshow">Top Slideshow</option>
                    <?php } ?>
...
function addRoute() {
  ...
  html += '  <option value="top_slideshow">Top slideshow</option>';
	<?php foreach ($stores as $store) { ?>
