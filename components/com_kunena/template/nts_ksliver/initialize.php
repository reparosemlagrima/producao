...
//Add Fontawesome
CKunenaTools::addStyleSheet ( JURI::root(true). "/components/com_kunena/template/nts_ksliver/fonts/font-awesome/css/font-awesome.min.css" );

//Theme for template
$theme_color = $template->params->get('theme_color', 'default');

if (is_file( JPATH_ROOT . "/templates/{$app->getTemplate()}/css/colors/".$theme_color.".css" )) {
...
if (is_file( JPATH_ROOT . "/templates/{$app->getTemplate()}/css/nts-ksliver-custom.css" )) {
	CKunenaTools::addStyleSheet ( JURI::root(true). "/templates/{$app->getTemplate()}/css/nts-ksliver-custom.css" );
}
