...
//menuforum
$modulemenu =& JModuleHelper::getModule('gambeta');
echo JModuleHelper::renderModule($modulemenu); 
					...
					<tr class="krow1">
						...
						<td class="kprofileboxcnt">
							...
							<ul class="kprofilebox-welcome">
								...
								<li class="kms">
									<strong>
										<?php echo JText::_('COM_KUNENA_MYPROFILE_LASTLOGIN'); ?>:
									</strong>
