...
<div id="kprofile-stats">
	<ul>
		...
		<?php if(!empty($this->registerdate)): ?>
			<li>
				...
				<span title="<?php echo KunenaDate::getInstance($this->registerdate)->toKunena('ago'); ?>">
					<?php echo KunenaDate::getInstance($this->registerdate)->toKunena('date_today'); ?>
				</span>
			</li>
		<?php endif; ?>
		...
		<?php if(!empty($this->lastvisitdate)): ?>
			<li>
				...
				<span title="<?php echo KunenaDate::getInstance($this->lastvisitdate)->toKunena('ago'); ?>">
					<?php echo KunenaDate::getInstance($this->lastvisitdate)->toKunena('date_today'); ?>
				</span>
			</li>
		<?php endif; ?>
		...
		<?php if(!empty($this->usermedals)): ?>
			<li>
				<?php
					foreach($this->usermedals as $medal):
						echo $medal,' ';
					endforeach;
				?>
			</li>
		...
		<li>
			<strong>
				<?php echo JText::_('COM_KUNENA_MYPROFILE_PROFILEVIEW'); ?>:
			</strong>
