...
?>
		<div class="kblock">
			<div class="kheader">
				<span class="ktoggler">
					<a class="ktoggler close" title="<?php echo JText::_('COM_KUNENA_TOGGLER_COLLAPSE') ?>" rel="frontstats_tbody"></a>
				</span>
...
?>
		...
		<div class="klist-actions-bottom clearfix" >
			<div class="klist-actions-goto">
				<a id="forumbottom"> </a>
				<a  class="kbuttongoto" href="#forumtop" rel="nofollow">
					<?php echo $this->getIcon ( 'kforumtop', JText::_('COM_KUNENA_GEN_GOTOTOP') ) ?>
				</a>
			</div>
			<?php $this->displayCategoryActions() ?>
			<div class="klist-pages-all">
