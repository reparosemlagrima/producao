...
<div class="nts-kblock kblock kcategories-<?php echo intval($section->id) ?>">
	<div class="kheader">
		...
		<?php endif; ?>
		<h2> Reparo sem lágrimas <span><?php echo $this->GetCategoryLink ( $section, $this->escape($section->name) ); ?></span></h2>
  ...
  <ul class="kblocktable<?php echo $htmlClassBlockTable ?>" id="kcat<?php echo intval($section->id) ?>">
  	...
  	?>
  		<li class="k<?php echo $tabclass [$k ^= 1], isset ( $category->class_sfx ) ? ' k' . $this->escape($tabclass [$k]) . $this->escape($category->class_sfx) : '' ?>"
        ...
        <!-- // Sub categories -->
          ...
          <div class="kcol-mid kcol-kcattopics hidden-phone">
    			...
    			<div class="kcol-mid kcol-kcatreplies hidden-phone">
