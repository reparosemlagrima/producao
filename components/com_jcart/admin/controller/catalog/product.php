...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			if (is_file(DIR_IMAGE . $result['image']) || defined("MAIN_HTTP_SERVER")) {
	...
	protected function getForm() {
		...
		} elseif (!empty($product_info) && (is_file(DIR_IMAGE . $product_info['image']) || defined("MAIN_HTTP_SERVER"))) {
		...
		foreach ($product_images as $product_image) {
			if (is_file(DIR_IMAGE . $product_image['image']) || defined("MAIN_HTTP_SERVER")) {
