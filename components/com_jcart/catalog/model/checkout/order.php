	...
	public function addOrderHistory($order_id, $order_status_id, $comment = '', $notify = false, $override = false) {
		...
		if ($order_info) {
			...
			if (!$order_info['order_status_id'] && $order_status_id) {
				...
				$data['logo'] = $this->config->get('config_url') . JCART_RELATIVE_URL . 'image/' . $this->config->get('config_logo');
				$data['store_name'] = $order_info['store_name'];
				$data['store_url'] = $order_info['store_url'];
				$data['customer_id'] = $order_info['customer_id'];
				$data['link'] = $order_info['store_url'] . 'index.php?option=com_jcart&'.ITEM_ID.'route=account/order/info&order_id=' . $order_id;
	
				if ($download_status) {
					$data['download'] = $order_info['store_url'] . 'index.php?option=com_jcart&'.ITEM_ID.'route=account/download';
				} else {
					$data['download'] = '';
				}
				...
				if ($order_info['customer_id']) {
					$text .= $language->get('text_new_link') . "\n";
						$text .= $order_info['store_url'] . 'index.php?option=com_jcart&'.ITEM_ID.'route=account/order/info&order_id=' . $order_id . "\n\n";
				}
	
				if ($download_status) {
					$text .= $language->get('text_new_download') . "\n";
						$text .= $order_info['store_url'] . 'index.php?option=com_jcart&'.ITEM_ID.'route=account/download' . "\n\n";
				}
			...
			if ($order_info['order_status_id'] && $order_status_id && $notify) {
				...
				if ($order_info['customer_id']) {
					...
					$message .= $order_info['store_url'] . 'index.php?option=com_jcart&'.ITEM_ID.'route=account/order/info&order_id=' . $order_id . "\n\n";
				}
