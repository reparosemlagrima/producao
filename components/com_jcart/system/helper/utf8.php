...
if(file_exists(JPATH_SITE."/libraries/vendor/joomla/string/src/phputf8/utf8.php"))
require_once(JPATH_SITE."/libraries/vendor/joomla/string/src/phputf8/utf8.php");
elseif(file_exists(JPATH_SITE."/libraries/phputf8/utf8.php"))
require_once(JPATH_SITE."/libraries/phputf8/utf8.php");
