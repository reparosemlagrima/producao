		            	...
		            	<div class="bfProperties" id="bfElementProperties" style="display:none">
		            		...
		            		<fieldset>
		            			...
		            			<div class="bfElementTypeClass" id="bfElementTypeText" style="display:none">
			            			...
			            			<br/>
			            			<br/>
                                                        <label class="bfPropertyLabel" for="bfElementTypeTextPlaceholder"><?php echo BFText::_('COM_BREEZINGFORMS_ELEMENT_TEXT_PLACEHOLDER'); ?></label>
		            			...
		            			<div class="bfElementTypeClass" id="bfElementTypeTextarea" style="display:none">
			            			...
			            			<br/>
			            			<br/>
                                                        <label class="bfPropertyLabel" for="bfElementTypeTextareaPlaceholder"><?php echo BFText::_('COM_BREEZINGFORMS_ELEMENT_TEXT_PLACEHOLDER'); ?></label>
		            			...
		            			<div class="bfElementTypeClass" id="bfElementTypeCaptcha" style="display:none">
			            			...
			            			<textarea id="bfElementTypeCaptchaHint"></textarea>
                                                        <br/>
			            			<label class="bfPropertyLabel" for="bfElementTypeCaptchaWidth"><?php echo BFText::_('COM_BREEZINGFORMS_ELEMENT_CAPTCHA_WIDTH'); ?></label>
	            	...
	            	<div>
		            	...
		            	<div class="bfAdvanced" id="bfFormAdvanced" style="display:none">
			            	...
			            	<fieldset>
                                                ...
                                                <label class="bfPropertyLabel" for="bfThemeBootstrapThemeBreezingForms"><?php echo BFText::_('COM_BREEZINGFORMS_CHOOSE_THEME_ENGINE'); ?></label>
			            		...
			            		?>
                                                ...
                                                <br/>
                                                <label class="bfPropertyLabel" for="bfThemeBootstrap"><?php echo BFText::_('COM_BREEZINGFORMS_THEME_BOOTSTRAP'); ?></label>
...
>			            		<?php
			            		...
			            		<?php
                                                ...
                                                if(version_compare($version->getShortVersion(), '3.0', '<')){
                                                ?>
                                                <label class="bfPropertyLabel" for="bfThemeBootstrapUseLegacyYes"><?php echo BFText::_('COM_BREEZINGFORMS_THEME_BOOTSTRAP_USE_LEGACY'); ?></label>
			            		...
			            		<br/>
                                                ...
                                                ?>
                                                <label class="bfPropertyLabel" for="bfThemeBootstrapLabelTopYes"><?php echo BFText::_('COM_BREEZINGFORMS_THEME_BOOTSTRAP_LABELTOP'); ?></label>
                                                ...
                                                <br/>
			            		<br/>
                                                <label class="bfPropertyLabel" for="bfThemeBootstrapUseHeroUnitYes"><?php echo BFText::_('COM_BREEZINGFORMS_THEME_BOOTSTRAP_USE_HERO_UNIT'); ?></label>
                                                ...
                                                <br/>
			            		<br/>
                                                <label class="bfPropertyLabel" for="bfThemeBootstrapUseWellYes"><?php echo BFText::_('COM_BREEZINGFORMS_THEME_BOOTSTRAP_USE_WELL'); ?></label>
                                                ...
                                                <br/>
			            		<br/>
                                                <label class="bfPropertyLabel" for="bfThemeBootstrapUseProgressYes"><?php echo BFText::_('COM_BREEZINGFORMS_THEME_BOOTSTRAP_USE_PROGRESS'); ?></label>
                                                ...
                                                if(isset($dbObject['properties']['themebootstrap'])){
                                                    ...
                                                    if(JFolder::exists($themesbootstrap_path) && JFile::exists($themesbootstrap_path.'vars.txt')){
                                                        ...
                                                        if($varscontent){
                                                            echo '<br/>
                                                                <br/>
                                                                <label class="bfPropertyLabel" for="bfThemeBootstrapVars">'.BFText::_('COM_BREEZINGFORMS_THEME_BOOTSTRAP_VARS').'</label>
			            ...
			            <div class="bfAdvanced" id="bfElementAdvanced" style="display:none">
			            	...
			            	<fieldset>
			            		...
			            		<div class="bfElementTypeClass" id="bfElementTypeFileAdvanced" style="display:none">
                                                        <label class="bfPropertyLabel" for="bfElementFileAdvancedHtml5Uploader"><?php echo BFText::_('COM_BREEZINGFORMS_HTML5_UPLOADER'); ?></label>
			            			...
			            			<br/>
			            			<br/>
                                                        <label class="bfPropertyLabel" for="bfElementFileAdvancedResizeTargetWidth"><?php echo BFText::_('COM_BREEZINGFORMS_RESIZE_TARGET_WIDTH'); ?></label>
			            			<input type="text" value="" id="bfElementFileAdvancedResizeTargetWidth" value="0"/>
			            			<br/>
			            			<br/>
                                                        <label class="bfPropertyLabel" for="bfElementFileAdvancedResizeTargetHeight"><?php echo BFText::_('COM_BREEZINGFORMS_RESIZE_TARGET_HEIGHT'); ?></label>
			            			<input type="text" value="" id="bfElementFileAdvancedResizeTargetHeight" value="0"/>
			            			<br/>
			            			<br/>
                                                        <label class="bfPropertyLabel" for="bfElementFileAdvancedResizeType"><?php echo BFText::_('COM_BREEZINGFORMS_RESIZE_TYPE'); ?></label>
			            			<input type="text" value="" id="bfElementFileAdvancedResizeType" value=""/>
			            			<br/>
			            			<br/>
                                                        <label class="bfPropertyLabel" for="bfElementFileAdvancedResizeBgcolor"><?php echo BFText::_('COM_BREEZINGFORMS_RESIZE_BGCOLOR'); ?></label>
