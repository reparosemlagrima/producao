...
?>
			...
			<table width="80%" cellpadding="4" cellspacing="1" border="0">
                   ...
                   <tr>
                        <td style="width: 200px;" valign="top"><?php echo BFText::_('COM_BREEZINGFORMS_SF_USERNAME'); ?></td>
                        <td valign="top"><input type="text" name="dropbox_email"  value="<?php echo $row->dropbox_email; ?>" size="50"  class="inputbox"/></td>
                    </tr>
                    
                    <tr>
                        <td valign="top"><?php echo BFText::_('COM_BREEZINGFORMS_SF_PASSWORD'); ?></td>
                        <td valign="top"><input type="password" name="dropbox_password"  value="<?php echo $row->dropbox_password; ?>" size="50"  class="inputbox"/></td>
                    </tr>
