			...
			<table class="table table-striped" id="userList">
				<thead>
					<tr>
						...
						<th><?php echo JHtml::_('grid.sort', 'Agradecimentos', 'thankyou', $this->state->get('list.direction'), $this->state->get('list.ordering') ); ?>
						</th>
					...
					<tr>
						...
						<td class="nowrap">
							<label for="filter_thanks" class="element-invisible">Agradecimentos</label>
							<input class="input-block-level input-filter filter" type="text" name="filter_thankyou" id="filter_thankyou" placeholder="Agradecimentos" value="<?=$this->filterThankyou;?>" title="" />
						</td>
						<td class="nowrap">
				...
				?>
					<tr>
						...
						<td class="center">
							<?php echo $this->escape($user->thankyou); ?>
						</td>
						<td>
