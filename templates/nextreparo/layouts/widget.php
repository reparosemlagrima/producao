...
// Set default panel
if ($panel == '' && in_array($widget->position, array('top-a','top-menu','new-top-a','new-menu','new-status','search-top','search-home','top-b', 'top-c', 'top-d', 'bottom-a', 'bottom-b', 'bottom-c', 'bottom-d', 'bottom-e', 'main-top', 'main-bottom', 'sidebar-a', 'sidebar-b'))) {
