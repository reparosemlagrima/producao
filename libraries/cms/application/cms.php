...
class JApplicationCms extends JApplicationWeb
{
	...
	public function afterSessionStart()
	{
		...
		if ($_SERVER['HTTP_HOST'] == 'localhost'){
			if (is_file($_SERVER['DOCUMENT_ROOT'].'/reparosemlagrima/loja/config_local.php')) {
				require_once($_SERVER['DOCUMENT_ROOT'].'/reparosemlagrima/loja/config_local.php');
			}}
		else {
			if (is_file($_SERVER['DOCUMENT_ROOT'].'/reparosemlagrima/loja/config.php')) {
				require_once($_SERVER['DOCUMENT_ROOT'].'/reparosemlagrima/loja/config.php');
			}
		}
